...
public class ReplacerMojo extends AbstractMojo {
    ...
    /**
     * Indicates if the value file is a proxy.
     * If the file is a proxy then policies referenced by it are copied
     * from specified source directory to the specified target directory.
     *
    ...
    /**
     * Output to directory for the policies.
     * This is optional parameter, by default it is apiproxy/policies under the directory containing
     * the replaced files.
     *
     * @parameter default-value="../policies"
     */
    private String outputPolicyDir;


    /**
     * Optional source policy directory for each file to replace.
     * Default value is "../policies" relative to location of the proxy file location.
     *
     * @parameter default-value="../policies"
     */
    private String srcPolicyDir;

    /**
     * Optional resources directory used by policies.
     * Default value is "../resources/jsc" relative to location of the proxy file location.
     *
     * @parameter default-value="../resources/jsc"
     */
    private String srcResourceDir;

    /**
     * Output to directory for the resources dir.
     * This is optional parameter, by default it is resources/jsc under the directory containing
     * the replaced files.
     *
     * @parameter default-value="../resources/jsc"
     */
    ...
    private List<Replacement> buildReplacements() throws IOException {
        ...
        if (tokenValueMap == null) {
            Replacement replacement = new Replacement(fileUtils, token, value, unescape, xpath, encoding, isProxy);
    ...
    public void setOutputPolicyDir(String outputPolicyDir) {
        this.outputPolicyDir = outputPolicyDir;
    }

    public void setSrcPolicyDir(String srcPolicyDir) {
        this.srcPolicyDir = srcPolicyDir;
    }
    ...
    public void setOutputResourceDir(String outputResourceDir) {
